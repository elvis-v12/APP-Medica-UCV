    ...
    <head>
      ...
      <style>
        ...
        <div class="container">
            ...
            <a href="http://localhost/AppAlertaMedica/Cliente/Controlador/restablecer_psw.php?token='. $token. '" class="button" style="color: #fff; text-decoration: none; font-size: 16px; font-weight: bold;">Restablecer Contraseña</a>
